...
module.exports.ResourceType = {
  ...
  Resources: [
    ...
    },
    {
      ...
      schema: "urn:ietf:params:scim:schemas:2.0:Entitlements",
      meta: {
        location: "/Schemas/urn:ietf:params:scim:schemas:2.0:Entitlements",
        resourceType: "ResourceType",
      },
    },
  ],
  ...
  Resources: [
    {
      ...
      attributes: [
        ...
        },
        {
          ...
          subAttributes: [
            ...
            },
            {
              ...
              multiValued: false,
              description:
                "The family name of the User, or Last Namein most Western languages (e.g. Jensen given the full name Ms. Barbara JJensen, III.).",
              required: false,
              caseExact: false,
              mutability: "readWrite",
              returned: "default",
            ...
            },
            {
              ...
              multiValued: false,
              description:
                "The given name of the User, or First Namein most Western languages (e.g. Barbara given the full name Ms. BarbaraJ Jensen, III.).",
              required: false,
              caseExact: false,
              mutability: "readWrite",
              returned: "default",
        ...
        },
        {
          ...
          multiValued: false,
          description:
            "Used to identify the organization to user relationshipship. Typical values used might be 'Contractor', 'Employee', 'Intern', 'Temp', 'External', and 'Unknown' but any value may be used.",
          required: false,
          caseExact: false,
          mutability: "readWrite",
          returned: "default",
        ...
        },
        {
          ...
          subAttributes: [
            ...
            },
            {
              ...
              multiValued: false,
              description:
                "A label indicating the attribute's function; e.g., 'work' or 'home' or 'mobile' etc.",
              required: false,
              caseExact: false,
              canonicalValues: [
                "work",
        ...
        },
        {
          ...
          subAttributes: [
            ...
            },
            {
              ...
              multiValued: false,
              description:
                "A label indicating the attribute's function; e.g., 'aim', 'gtalk', 'mobile' etc.",
              required: false,
              caseExact: false,
              canonicalValues: [
                "aim",
    ...
    },
    {
      ...
      name: "Entitlement",
      description:
        "Entitlements available for use with the User resource's 'entitlements' attribute",
      attributes: [
        {
          name: "value",
          type: "string",
        ...
        },
        {
          ...
          multiValued: true,
          description:
            "A complex type that shows what other entitlements this entitlement indirectly grants - values can be considered the child entitlement in a parent/child relationship.",
          required: false,
          caseExact: false,
          mutability: "readOnly",
          returned: "default",
        },
        {
          ...
          multiValued: true,
          description:
            "A complex type that shows what other entitlements grant this entitlement indirectly - values can be considered the parent entitlement in a parent/child relationship.",
          required: false,
          caseExact: false,
          mutability: "readOnly",
          returned: "default",
        },
        {
          ...
          multiValued: false,
          description:
            "A boolean type that indicates if the entitlement has a numerical limit to how many users it may be assigned.",
          required: false,
          caseExact: false,
          mutability: "readOnly",
          returned: "default",
        },
        {
          ...
          multiValued: false,
          description:
            "An integer that specifies how many resources in total may be granted this entitlement.",
          required: true,
          caseExact: false,
          mutability: "readOnly",
          returned: "default",
        },
        {
          ...
          multiValued: false,
          description:
            "An integer that specifies how many resources in total have been granted this entitlement.",
          required: true,
          caseExact: false,
          mutability: "readOnly",
          returned: "default",
